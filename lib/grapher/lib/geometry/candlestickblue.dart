...
class CandlestickBlue extends Geometry with EndlinePropagator {
  ...
  CandlestickBlue() : super(BODY_PERCENT);
  ...
  Color getBodyColor(OHLC ohlc) {
    if (ohlc.open > ohlc.close) return Colors.lightBlue;
    return Colors.white;
  }
  ...
  @override
  DrawUnitObject instanciate() => CandlestickBlue();
}
